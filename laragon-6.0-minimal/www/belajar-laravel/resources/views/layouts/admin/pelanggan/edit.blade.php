@extends('layouts.admin.pelanggan.template')
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $dataPelanggan->first_name }}" type="text" id="first_name"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $dataPelanggan->last_name }}" type="text" id="last_name"
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $dataPelanggan->birthday }}" type="date" id="birthday"
                            ...
                            <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $dataPelanggan->email }}" type="text" id="email" name="email"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $dataPelanggan->phone }}" type="text" id="phone" name="phone"
                                        class="form-control">
                                </div>
